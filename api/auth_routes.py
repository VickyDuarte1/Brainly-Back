...
# Código para configurar Flask-Mail
...
def create_app():
    ...
    app.config['MAIL_USERNAME'] = 'tu_correo_electronico@gmail.com'
    app.config['MAIL_PASSWORD'] = 'tu_contraseña_de_correo_electronico'
    mail = Mail(app)  # instantiate Mail with app
    return app
...
def registrar_usuario():
    ...
    msg = Message('Bienvenido a mi aplicación', recipients=[correo])
    msg.body = 'Gracias por registrarte en mi aplicación. ¡Esperamos que disfrutes usándola!'
    mail.send(msg)
